module Config
  ...
  ENV_DEFAULTS = { "SEARCH_API_URL_DEBUG" => "https://c8tuq9oow3.execute-api.eu-west-1.amazonaws.com/dev/v2",
                   "SEARCH_API_URL_PRODUCTION" => "https://c8tuq9oow3.execute-api.eu-west-1.amazonaws.com/dev/v2",
