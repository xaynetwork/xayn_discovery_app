module Config
  ...
  ENV_DEFAULTS = { "SEARCH_API_URL_DEBUG" => "https://rerrruenzi.execute-api.eu-central-1.amazonaws.com/default",
                   "SEARCH_API_URL_PRODUCTION" => "https://rerrruenzi.execute-api.eu-central-1.amazonaws.com/default",
